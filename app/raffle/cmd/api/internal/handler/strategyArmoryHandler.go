...
func StrategyArmoryHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.StrategyArmoryRequest
		if err := httpx.Parse(r, &req); err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
			return
		}

		l := logic.NewStrategyArmoryLogic(r.Context(), svcCtx)
		resp, err := l.StrategyArmory(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
